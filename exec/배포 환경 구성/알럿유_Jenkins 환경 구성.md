...
Docker-Compose를 이용하여 젠킨스 이미지를 설치하고 빌드 환경을 구성하여, 작업 결과를 push했을 때, webhook을 통해 자동으로 빌드를 시작하게끔 설정까지 진행
...
도커 파일 작성은 Backend 항목에 작성해놓았으므로 해당 항목을 참조하면 됩니다.
...
![image](https://user-images.githubusercontent.com/97647987/202079969-3dae9bed-e1de-4a01-983a-95f3068a246c.png)

```bash
docker image prune -a --force
mkdir -p /var/jenkins_home/images_tar

cd /var/jenkins_home/workspace/alertyoupjt/BE/alertyou
...
![image](https://user-images.githubusercontent.com/97647987/202080156-655e9f90-0435-4ff7-9593-8d3bc90b0a9c.png)
