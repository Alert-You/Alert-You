      ...
      <Modal.Content width="95%">
        ...
        <Modal.Body>
          <FormControl>
            ...
            <Input
              placeholder="욧골공원 남자화장실 옆"
              value={state.place}
              onChangeText={changeReportPlace}
            />
          </FormControl>
          <FormControl mt={5}>
            ...
            <TextArea
              ...
              w="100%"
              value={state.content}
              onChangeText={changeReportContent}
            />
          </FormControl>
        </Modal.Body>
        <Modal.Footer>
